...
namespace APIVerve
{
    public class ArticleIdeasGeneratorAPIClient
    {
        ...
        public ArticleIdeasGeneratorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public ArticleIdeasGeneratorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
